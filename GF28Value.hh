...
public:
    ...
    GF28Value(unsigned int value) :
            m_value((unsigned char) value) {
    }
    ~GF28Value() {
    }
    ...
    inline GF28Value& operator=(const GF28Value &a) {
        this->m_value = a.value();
        return *this;
    }
    inline bool operator==(const GF28Value &a) const {
        return (this->m_value == a.value());
    }
    inline bool operator!=(const GF28Value &a) const {
        return !(this->m_value == a.value());
    }
    inline GF28Value operator+(const GF28Value &a) const {
        return GF28Value(this->value() ^ a.value());
    }
    inline GF28Value operator-(const GF28Value &a) const {
        return GF28Value(this->value() ^ a.value());
    }
    inline GF28Value operator*(const GF28Value &a) const {
        ...
        if (i == 0 || j == 0) {
            ...
            r = ins->getForward(
                    (ins->getBackward(i) + ins->getBackward(j)) % 255);
        }
        return GF28Value(r);
    }
    inline GF28Value operator/(const GF28Value &a) const {
        ...
        if (j == 0) {
            ...
            r = ins->getForward(
                    (ins->getBackward(i) + ins->getBackward(ins->getReverse(j)))
                            % 255);
        }
        return GF28Value(r);
    }
    ...
    inline static unsigned int limit(void) {
        return 256;
    }
protected:
